...
Options[CseWriteCpp]={Directory->".",ArgumentLists->{},ArgumentDimensions->{},SubstitutionRules->{},TemplateFile->FileNameJoin[{"template","template.cc"}],TemplateHeader->FileNameJoin[{"template","template.hh"}],Namespace->"Kneed_gait_expr",Behavior->"basic"};
